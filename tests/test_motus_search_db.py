...
class TestMotusSearchDB(unittest.TestCase):
    ...
    def test_init(self, mock_gzip_open):
        ...
        self.assertEqual(db._tax_2_motu_and_genome, {'Bacteria': {'MOTU2', 'MOTU1', 'genome1', 'genome2'}, 'Proteobacteria': {'MOTU1', 'genome1'}, 'Gammaproteobacteria': {'MOTU1', 'genome1'}, 'Enterobacterales': {'MOTU1', 'genome1'}, 'Enterobacteriaceae': {'MOTU1', 'genome1'}, 'Escherichia': {'MOTU1', 'genome1'}, 'coli': {'MOTU1', 'genome1'}, 'Firmicutes': {'MOTU2', 'genome2'}, 'Bacilli': {'MOTU2', 'genome2'}, 'Lactobacillales': {'MOTU2', 'genome2'}, 'Streptococcaceae': {'MOTU2', 'genome2'}, 'Streptococcus': {'MOTU2', 'genome2'}, 'pneumoniae': {'MOTU2', 'genome2'}})
